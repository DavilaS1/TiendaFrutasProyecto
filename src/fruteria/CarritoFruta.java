 ...
 private DefaultTableModel modelo;
   ...
   Ventas venta = new Ventas();
    ...
    private void initComponents() {
        ...
        jButtonAdd.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jPanel1.add(jButtonAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, -1, -1));
        ...
        jButtonElimiCliente.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButtonEliminarproducto.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jPanel1.add(jButtonEliminarproducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 340, 90, -1));

        jButtonEliminarSubtotal.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButtonAddCliente.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButtonAddProducto.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButton1.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButton2.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jButton3.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 370, 80, -1));

        jButton4.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 520, -1, -1));

        jButton5.setBackground(new java.awt.Color(255, 190, 118));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 520, -1, -1));
    ...
    private void jButtonAddClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddClienteActionPerformed
        ...
        if(jTextFieldNombreCli.getText().isEmpty() || jTextFieldApellido.getText().isEmpty() || jTextFieldCedula.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Por favor llenar las casillas obligatorias");
        }
        ...
        try{ 
           int row= jTableProducto.getSelectedRow();
            if(row>=0){
                ...
                int cantidad = Integer.parseInt(modelo.getValueAt(row, 1).toString());
                double precio = Double.parseDouble(modelo.getValueAt(row, 2).toString());
                
                EditarFrutas a= new EditarFrutas(nombre,cantidad,precio, modelo, row , jTableProducto, this);
                a.setVisible(true);
...
//            
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String filePath = "C:\\clientes.txt";
        File file = new File(filePath);
        try {
            FileWriter fw = new FileWriter(file);
            BufferedWriter bw = new BufferedWriter(fw);
            
            for(int i = 0; i < jTableClientes.getRowCount(); i++){//rows
                for(int j = 0; j < jTableClientes.getColumnCount(); j++){//columns
                    bw.write(jTableClientes.getValueAt(i, j).toString()+" ");
                }
                bw.newLine();
            }
            ...
            Logger.getLogger(CarritoFruta.class.getName()).log(Level.SEVERE, null, ex);
        }
